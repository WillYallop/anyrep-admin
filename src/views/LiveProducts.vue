<template>
    <div id="live-products" class="viewContainer">
      <div class="dashboardContentRow">
          <div class="outOfStockContainer" v-if="!emptyStore"> 
              <h1 class="desktopPageTitle">Live Products</h1>
              <p>These are your live products. Click on them to edit their details or delete them off your store!</p>
          </div>
          <!-- No Products -->
          <div class="outOfStockContainer" v-if="emptyStore"> 
              <h1 class="desktopPageTitle">Live Products</h1>
              <p>Your store currently has no products! Navigate to the add product page by clicking the navigation link, or the red circle at the bottom right of the page!</p>
          </div>
